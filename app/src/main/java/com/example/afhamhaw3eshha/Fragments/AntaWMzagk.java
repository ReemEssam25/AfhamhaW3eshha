 ...
 */
public class AntaWMzagk extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_anta_wmzagk, container, false);

        recyclerView = v.findViewById(R.id.AntaWMzagk_RecycleView);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < posts.size(); i++) {
                    if (posts.get(i).getCategory() == "انت ومزاجك") ;
                    {
