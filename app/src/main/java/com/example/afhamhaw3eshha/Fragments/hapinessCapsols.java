 ...
 */
public class hapinessCapsols extends Fragment {
    private RecyclerView recyclerView;
    private ArticleAdapter adapter;
    List<Post> posts;
    List<Post> posts2;

    public hapinessCapsols() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_hapiness_capsols, container, false);

        recyclerView = v.findViewById(R.id.happiness_capsols_RecycleView);
     ...
     reference.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             for (int i = 0; i < posts.size(); i++) {
                 if (posts.get(i).getCategory() == "كبسولات السعادة") ;
                 {
