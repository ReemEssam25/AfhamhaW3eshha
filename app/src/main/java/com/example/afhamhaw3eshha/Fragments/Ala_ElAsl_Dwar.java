 ...
 */
public class Ala_ElAsl_Dwar extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ala__el_asl__dwar, container, false);

        recyclerView = v.findViewById(R.id.Ala_ElAsl_Dwar_RecycleView);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < posts.size(); i++) {
                    if (posts.get(i).getCategory() == "علي الاصل دور") ;
                    {
