 ...
 */
public class E5tlaf_Mesh_5laf extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_e5tlaf__mesh_5laf, container, false);

        recyclerView = v.findViewById(R.id.E5tlaf_Mesh_5laf_RecycleView);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < posts.size(); i++) {
                    if (posts.get(i).getCategory() == "اختلاف مش خلاف") ;
                    {
