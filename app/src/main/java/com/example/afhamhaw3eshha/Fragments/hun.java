 ...
 */
public class hun extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_hun, container, false);

        recyclerView = v.findViewById(R.id.hun_RecycleView);
